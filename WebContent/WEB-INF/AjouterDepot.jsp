	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="insert.php" method="get">
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Veuillez Entrer L'ID Du Depot">
					<span class="label-input100">ID Depot *</span>
					<input class="input100" type="text" name="iddepot" placeholder="ID Du Depot">
				</div>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Veuillez Entrer Nombres de Places	">
					...
					<input class="input100" type="text" name="nombres de Places" placeholder="Nombres de Places ">
				</div>
