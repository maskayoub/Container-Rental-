		...
		<div class="container-table100">
		  ...
		  <c:forEach items="${model.conteneurs}" var="c">
		    <tr>
		      ...
		      <th><a href="louer.php?id=${c.getId()}"  class="btn btn-default" onclick="return confirm('Êtes-vous sûr de bien vouloir louer cet élément?');">Louer</a></th>
		    </tr>
		   </c:forEach>
