	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="insert.php" method="get">
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Veuillez Entrer La Capacité">
					<span class="label-input100">Capacité *</span>
					<input class="input100" type="text" name="capacite" placeholder="Capacité ">
				</div>
