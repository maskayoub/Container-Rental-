...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="update_depot.php" method="get">
				...
				<div class="container-contact100-form-btn">
					<button class="contact100-form-btn" onclick="return confirm('Êtes-vous sûr de bien vouloir modifier cet élément?');" name ="modifier"  value="modifierDepot" >
						<span>
							Submit
